...
SING_BOX_IMAGE=fluxgate-sing-box:latest
SING_BOX_CUSTOM_BUILD_ENABLED=true
SING_BOX_VERSION=latest
SING_BOX_BUILD_TAGS=with_v2ray_api with_quic with_grpc with_wireguard with_utls with_acme with_clash_api
SING_BOX_V2RAY_API_ADDR=sing-box:9090
SING_BOX_V2RAY_STATS_PATTERN=traffic
SING_BOX_V2RAY_API_TIMEOUT_SECONDS=5
