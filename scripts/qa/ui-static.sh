...
require_pattern "$CALM_CSS_FILE" 'body\.is-authenticated \.topbar \{' "authenticated topbar must become a lightweight status rail"
...
require_pattern "$CALM_CSS_FILE" 'body\.is-authenticated \.workspace \{' "authenticated workspace must reserve room for the fixed status rail"
