...
type Config struct {
	...
	SubStoreExtractURLTemplate string
	SubStoreTimeout            time.Duration
...
func Load() Config {
	return Config{
		...
		SubStoreExtractURLTemplate: env("SUB_STORE_EXTRACT_URL_TEMPLATE", ""),
		SubStoreTimeout:            time.Duration(envInt("SUB_STORE_TIMEOUT_SECONDS", 20)) * time.Second,
