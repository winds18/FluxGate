...
func appendClashTransportQueryValues(proxy map[string]string, values url.Values) {
	...
	wsHost := firstMapValue(proxy, "ws-headers.host", "ws_headers.host", "ws-opts.headers.host", "ws_opts.headers.host", "ws-opts.headers.authority", "ws_opts.headers.authority", "ws-opts.headers.:authority", "ws_opts.headers.:authority", "ws-opts.authority", "ws_opts.authority", "transport.ws-headers.host", "transport.ws_headers.host", "transport.headers.host", "ws-host", "ws_host", "transport.ws-host", "transport.ws_host")
	...
	tcpHTTPHeaderType := firstMapValue(proxy, "tcp-opts.header.type", "tcp_opts.header.type", "tcp-opts.headers.type", "tcp_opts.headers.type")
	httpPath := firstMapValue(proxy, "http-opts.path", "http_opts.path", "transport.http-opts.path", "transport.http_opts.path", "tcp-opts.header.request.path", "tcp_opts.header.request.path")
	httpHost := firstMapValue(proxy, "http-opts.host", "http_opts.host", "http-opts.headers.host", "http_opts.headers.host", "http-opts.headers.authority", "http_opts.headers.authority", "http-opts.headers.:authority", "http_opts.headers.:authority", "http-opts.authority", "http_opts.authority", "transport.http-opts.host", "transport.http_opts.host", "transport.http-opts.headers.host", "transport.http_opts.headers.host", "transport.http-opts.headers.authority", "transport.http_opts.headers.authority", "transport.http-opts.headers.:authority", "transport.http_opts.headers.:authority", "tcp-opts.header.request.host", "tcp_opts.header.request.host", "tcp-opts.header.request.headers.host", "tcp_opts.header.request.headers.host")
	...
	httpUpgradeHost := firstMapValue(proxy, "httpupgrade-opts.host", "httpupgrade_opts.host", "httpupgrade-opts.headers.host", "httpupgrade_opts.headers.host", "httpupgrade-opts.headers.authority", "httpupgrade_opts.headers.authority", "httpupgrade-opts.headers.:authority", "httpupgrade_opts.headers.:authority", "httpupgrade-opts.authority", "httpupgrade_opts.authority", "http-upgrade-opts.host", "http_upgrade_opts.host", "http-upgrade-opts.headers.host", "http_upgrade_opts.headers.host", "http-upgrade-opts.headers.authority", "http_upgrade_opts.headers.authority", "http-upgrade-opts.headers.:authority", "http_upgrade_opts.headers.:authority", "http-upgrade-opts.authority", "http_upgrade_opts.authority", "transport.httpupgrade-opts.host", "transport.httpupgrade_opts.host", "transport.httpupgrade-opts.headers.host", "transport.httpupgrade_opts.headers.host", "transport.httpupgrade-opts.headers.authority", "transport.httpupgrade_opts.headers.authority", "transport.httpupgrade-opts.headers.:authority", "transport.httpupgrade_opts.headers.:authority", "transport.http-upgrade-opts.host", "transport.http_upgrade_opts.host", "transport.http-upgrade-opts.headers.host", "transport.http_upgrade_opts.headers.host", "transport.http-upgrade-opts.headers.authority", "transport.http_upgrade_opts.headers.authority", "transport.http-upgrade-opts.headers.:authority", "transport.http_upgrade_opts.headers.:authority")
	httpMethod := firstMapValue(proxy, "http-opts.method", "http_opts.method", "transport.http-opts.method", "transport.http_opts.method", "transport.method", "method", "tcp-opts.header.request.method", "tcp_opts.header.request.method")
	...
	if strings.EqualFold(transportType, "tcp") && strings.EqualFold(tcpHTTPHeaderType, "http") {
		transportType = "http"
	}
	if strings.EqualFold(transportType, "ws") || strings.EqualFold(transportType, "websocket") {
		...
		wsHost = firstNonEmptyString(wsHost, firstMapValue(proxy, "transport.host", "transport.headers.host", "transport.authority", "transport.headers.authority", "transport.headers.:authority"))
	}
	if strings.EqualFold(transportType, "http") {
		httpPath = firstNonEmptyString(httpPath, firstMapValue(proxy, "transport.path"))
		httpHost = firstNonEmptyString(httpHost, firstMapValue(proxy, "transport.host", "transport.headers.host", "transport.authority", "transport.headers.authority", "transport.headers.:authority"))
	}
	if strings.EqualFold(transportType, "httpupgrade") {
		...
		httpUpgradeHost = firstNonEmptyString(httpUpgradeHost, firstMapValue(proxy, "transport.host", "transport.headers.host", "transport.authority", "transport.headers.authority", "transport.headers.:authority"))
	}
	path = firstNonEmptyString(wsPath, httpPath, httpUpgradePath, firstMapValue(proxy, "path"))
	host = firstNonEmptyString(wsHost, httpHost, httpUpgradeHost, firstMapValue(proxy, "host"))
	...
	if transportType == "" && firstMapValue(proxy, "quic-opts.security", "quic_opts.security") != "" {
		transportType = "quic"
	}
	if transportType == "" && strings.EqualFold(tcpHTTPHeaderType, "http") {
		transportType = "http"
	}
