...
singbox_subscription_raw="$(node -e 'process.stdout.write(JSON.stringify(JSON.stringify({outbounds:[{type:"shadowsocks",tag:"香港 05",server:"singbox.example.sub",server_port:8388,method:"aes-128-gcm",password:"qa-placeholder"},{type:"hysteria2",tag:"香港 06",server:"hy2.singbox.example.sub",server_port:443,password:"hy2-placeholder",obfs:{type:"salamander",password:"obfs-placeholder"},tls:{enabled:true,server_name:"hy2.singbox.example.sub",insecure:true}},{type:"tuic",tag:"东京 06",server:"tuic.singbox.example.sub",server_port:443,uuid:"00000000-0000-0000-0000-000000000049",password:"tuic-placeholder",congestion_control:"bbr",udp_relay_mode:"native",tls:{enabled:true,server_name:"tuic.singbox.example.sub"}},{type:"anytls",tag:"首尔 06",server:"anytls.singbox.example.sub",server_port:443,password:"anytls-placeholder",idle_session_check_interval:"20s",idle_session_timeout:"45s",min_idle_session:2,tls:{enabled:true,server_name:"anytls.singbox.example.sub"}},{type:"shadowtls",tag:"东京 07",server:"shadow.singbox.example.sub",server_port:443,version:3,password:"shadow-placeholder",tls:{enabled:true,server_name:"shadow.singbox.example.sub",insecure:true}},{type:"hysteria",tag:"香港 07",server:"hysteria.singbox.example.sub",server_port:443,auth_str:"hysteria-auth",up_mbps:20,down_mbps:80,obfs:"obfs-placeholder",network:"udp",tls:{enabled:true,server_name:"hysteria.singbox.example.sub",insecure:true,alpn:["h3"]}},{type:"http",tag:"首尔 07",server:"http.singbox.example.sub",server_port:8443,username:"qa-user",password:"http-placeholder",path:"/connect",tls:{enabled:true,server_name:"http.singbox.example.sub",insecure:true}},{type:"socks",tag:"大阪 07",server:"socks.singbox.example.sub",server_port:1080,username:"qa-user",password:"socks-placeholder",version:"5",network:"udp",udp_over_tcp:true}]})));')"
